...
<body>
	...
	<div id="menu">
		<ul>
			...
			<li><form class="form-inline my-2 my-lg-0" action="main/login.htm" method="post">
	...
	<div>
		<div style="color: white; size: 16px; padding-left: 10px"><b>${message}</b></div>
		<c:forEach var="music" items="${list}">
			<div
				...
				<div class="row align-items-start">
					...
					<div class="col">
						<audio controls="controls" src="${music.uriAudio}"
