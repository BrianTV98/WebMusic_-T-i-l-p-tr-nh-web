			...
			<div class="clo-8">					
				<div>
					<h2 class="text-center"; style="padding-top: 30px">UPLOAD MUSIC</h2>			
					 <form:form action="main/uploadMusic.htm" modelAttribute="music" enctype="multipart/form-data" class="login-form">
						...
						<div id="default_padding">
							...
							<form:input type="file" path="fileAudio"/>
							<form:errors path="fileAudio" id="abc"/>
						</div>
