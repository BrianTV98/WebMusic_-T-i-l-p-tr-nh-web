		...
		<div class="row">
				<c:forEach var="album" items="${list}" >
					<div class="col">
						<div class="row" >
							<div class="col">
								<a href="main/album/${album.idAlbum}.htm"><img alt="" src="${album.linkHinhAlbum}" id="sizeImage"/></a>
								<div style="padding-left: 30px">Album  :${album.tenAlbum}</div>
								<div style="padding-left: 30px">Tác giả:${album.tenCaSiALbum}</div>
							</div>
